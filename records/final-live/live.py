...
repo=Path('$WORKSPACE/extras/der-checkouts/vs1-validation-r1-p3')
root=Path('$WORKSPACE/extras/preflight/vs1-validation-final/runtime')
e=Path('$WORKSPACE/extras/der-evidence/vs1-validation/r1/final-live')
...
with httpx.Client(base_url='http://127.0.0.1:8004',trust_env=False,timeout=30,headers={'Origin':'http://127.0.0.1:8004'}) as client:
