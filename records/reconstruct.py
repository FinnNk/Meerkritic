...
S=ROOT/'extras/der-checkouts/vs2-interaction-semantic';E=ROOT/'extras/der-evidence/vs2-interaction/r1'
BASE='ff9af2e68d989590ebe030002e2e3789c35efef0'; D='f6de3b9bb5c119e516ccb270a3b1b95a34a81f6d'
phase=sys.argv[1]
def git(*args,cwd=S):
...
if phase=='p1':
    if not S.exists():git('worktree','add','-b','feat/vs2-interaction',str(S),BASE,cwd=R)
...
'''
    ...
    finalpaths=['src/semantic_reviewer/adapters/guidance.py','src/semantic_reviewer/adapters/maf_guidance.py',
        'src/semantic_reviewer/application/guidance.py','src/semantic_reviewer/domain/guidance.py',
