...
ROOT=Path('WORKSPACE');E=ROOT/'extras/der-evidence/source-reading/r1';PAIR=ROOT/'extras/der-evidence/pairs/source-reading';PUB=ROOT/'extras/der-publication/source-reading-r1';R=ROOT/'extras/der-checkouts/source-reading-semantic';W=ROOT/'working'
...
run(git+['fetch',PUB,'refs/heads/evidence/source-reading-r1:refs/heads/evidence/source-reading-r1']);run(git+['push','origin','refs/heads/evidence/source-reading-r1'])
sha=run(['git','-C',PUB,'rev-parse','HEAD']);refs=run(git+['ls-remote','origin','refs/heads/docs/repair-text-encoding','refs/heads/evidence/source-reading-r1','refs/heads/feat/source-reading'])
