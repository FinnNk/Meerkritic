...
ROOT=Path('WORKSPACE'); R=ROOT/'extras/der-checkouts/assessment-clarity-semantic'; E=ROOT/'extras/der-evidence/assessment-clarity/r1'; B=ROOT/'extras/der-checkouts/assessment-clarity-check-baseline'
