...
ROOT=Path('WORKSPACE');E=ROOT/'extras/der-evidence/vs2-draft-repair/r1';real=ROOT/'extras/research/edr-0001/runtime';copy=ROOT/'extras/research/edr-0001/upgrade-rehearsal-02';copy.mkdir(exist_ok=False)
def snapshot(path):
...
assert before['annotation']['count']==0
