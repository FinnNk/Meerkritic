...
ROOT=Path('WORKSPACE'); R=ROOT/'extras/der-checkouts/vs2-draft-repair-semantic'; E=ROOT/'extras/der-evidence/vs2-draft-repair/r1'; B=ROOT/'extras/der-checkouts/vs2-draft-repair-check-baseline'
PY=ROOT/'extras/der-checkouts/vs2-draft-repair/.venv/Scripts/python.exe'
