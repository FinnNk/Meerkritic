...
ROOT=Path('WORKSPACE'); R=ROOT/'extras/der-checkouts/vs2-study-tools-semantic'; E=ROOT/'extras/der-evidence/vs2-study-tools/r1'; B=ROOT/'extras/der-checkouts/vs2-study-tools-check-baseline'
