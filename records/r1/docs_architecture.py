...
ROOT=Path('WORKSPACE'); R=ROOT/'extras/der-checkouts/source-reading'; E=ROOT/'extras/der-evidence/source-reading/r1'; B=ROOT/'extras/der-checkouts/source-reading-check-baseline'
