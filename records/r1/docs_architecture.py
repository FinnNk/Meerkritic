...
ROOT=Path('WORKSPACE'); R=ROOT/'extras/der-checkouts/assessment-form'; E=ROOT/'extras/der-evidence/assessment-form/r1'; B=ROOT/'extras/der-checkouts/assessment-form-check-baseline'
