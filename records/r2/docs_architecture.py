...
ROOT=Path('WORKSPACE'); R=ROOT/'extras/der-checkouts/vs2-comparison-semantic-r2'; E=ROOT/'extras/der-evidence/vs2-comparison/r2'; B=ROOT/'extras/der-checkouts/vs2-comparison-check-baseline'
