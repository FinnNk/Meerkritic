...
ROOT = Path('$WORKSPACE')
REPO = ROOT/'extras/der-checkouts/vs1-architecture-review'
E = ROOT/'extras/der-evidence/vs1-architecture-review/r1'
PYTHON = '$USER_HOME/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/python.exe'
label, revision = sys.argv[1:]
checkout = ROOT/('extras/der-checkouts/vs1-architecture-review-'+label)
env = os.environ.copy()
