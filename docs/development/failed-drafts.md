...
| Step | What to do |
| --- | --- |
| Open the job | Read the failure message. **Save edited assessment** and **Reject** appear only when a retained semantic draft is available. |
...
![A failed draft retains its warning above the field editor.](../images/failed-draft-assessment.png)

The [synthetic demonstration](../images/README.md) is awaiting correction. No
